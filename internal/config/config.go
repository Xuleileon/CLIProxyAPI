...
type Config struct {
	...
	// ClaudeCloakDefaultSensitiveWords applies when a Claude credential does not define its own list.
	...
	// AmpCode contains the fork-maintained Amp routing configuration.
	AmpCode AmpCode `yaml:"ampcode" json:"ampcode"`

	// IncognitoBrowser opens OAuth sign-in in a private browser window when supported.
