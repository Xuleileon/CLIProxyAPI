...
func (e *OpenAICompatExecutor) HttpRequest(ctx context.Context, auth *cliproxyauth.Auth, req *http.Request) (*http.Response, error) {
	...
	return e.doHTTPRequest(ctx, httpClient, httpReq)
}

func (e *OpenAICompatExecutor) doHTTPRequest(ctx context.Context, client *http.Client, req *http.Request) (*http.Response, error) {
	if e.provider == "opencode-go" {
		return helps.DoOpenCodeGoRequest(ctx, client, req)
	}
...
func (e *OpenAICompatExecutor) Execute(ctx context.Context, auth *cliproxyauth.Auth, req cliproxyexecutor.Request, opts cliproxyexecutor.Options) (resp cliproxyexecutor.Response, err error) {
	...
	httpResp, err := e.doHTTPRequest(ctx, httpClient, httpReq)
	if err != nil {
